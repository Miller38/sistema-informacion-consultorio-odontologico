...
// Vuelve a pintar el contenedor para asegurarse de que la imagen se renderice correctamente
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 180, 30));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, -1, 70));
        ...
        getContentPane().add(Btn_regresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, -1, -1));
        getContentPane().add(jLabel_imagen_menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 290, 250));
