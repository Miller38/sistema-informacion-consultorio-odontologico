 ...
 *
 */
public class FrmGestionarPaciente extends javax.swing.JFrame {
...
// Vuelve a pintar el contenedor para asegurarse de que la imagen se renderice correctamente
    ...
    private void initComponents() {
        ...
        Btn_cerrarGestionarUsuarios = new javax.swing.JButton();
        ...
        jLabel_titulo.setText("Gestionar Paciente");
        getContentPane().add(jLabel_titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 30, 180, -1));
        ...
        jPanel3.add(txt_identificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 110, -1));
        ...
        jPanel3.add(txt_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 20, 120, -1));
        ...
        jPanel3.add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 60, 120, -1));
        ...
        Btn_cerrarGestionarUsuarios.setBackground(new java.awt.Color(255, 255, 255));
        Btn_cerrarGestionarUsuarios.setText("X");
        Btn_cerrarGestionarUsuarios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Btn_cerrarGestionarUsuariosActionPerformed(evt);
            }
        });
        getContentPane().add(Btn_cerrarGestionarUsuarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 10, -1, -1));
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 760, 520));
    ...
    private void Btn_cerrarGestionarUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_cerrarGestionarUsuariosActionPerformed
        ...
        // Establece la operación de cierre predeterminada para el JFrame, en este caso, DISPOSE_ON_CLOSE
        // Esto significa que cuando la ventana se cierre, los recursos utilizados por la ventana serán liberados, pero la aplicación continuará ejecutándose
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        // Llama al método dispose() para liberar todos los recursos utilizados por la ventana y cerrarla
        dispose();

    }//GEN-LAST:event_Btn_cerrarGestionarUsuariosActionPerformed

    private void Btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_actualizarActionPerformed

        // Verifica si todos los campos de texto están vacíos
        if (txt_usuario.getText().isEmpty() && txt_telefono.getText().isEmpty() && txt_nombre.getText().isEmpty()
                && txt_apellido.getText().isEmpty() && txt_identificacion.getText().isEmpty() && txt_direccion.getText().isEmpty()) {
            ...
            usuario.setPassword(txt_telefono.getText().trim());
            usuario.setNombre(txt_nombre.getText().trim());
            usuario.setApellido(txt_apellido.getText().trim());
            usuario.setTelefono(txt_identificacion.getText().trim());
            usuario.setEmail(txt_direccion.getText().trim());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGestionarPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGestionarPaciente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton Btn_cerrarGestionarUsuarios;
...
// Método para cargar la tabla de usuarios
    private void CargarTablaUsuarios() {
        ...
        try {
            ...
            FrmGestionarPaciente.jTable_pacientes = new JTable(model);
            // Asocia la tabla al panel de desplazamiento
            FrmGestionarPaciente.jScrollPane1.setViewportView(FrmGestionarPaciente.jTable_pacientes);
